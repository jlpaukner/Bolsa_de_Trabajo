...
(function (l) {
    ...
    function T(a, b, c, d) {
        ...
        if (k === q)
            return a.iDrawError != e && null === g && (da(a, 0, "Requested unknown parameter " + ("function" == typeof h.mData ? "{function}" : "'" + h.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = e), g;
        if ((k === f || null === k) && null !==
            g && d !== q)
            k = g;
    ...
    function wa(a, b, c, d) {
        ...
        if ("dom" !== c && (c && "auto" !== c || "dom" !== e.src)) {
            ...
            e._aData = ab(a, e, d, d === q ? q : e._aData).data;
        e._aSortData = null;
        e._aFilterData = null;
        f = a.aoColumns;
        if (d !== q)
    ...
    function ab(a, b, c, d) {
        ...
        if (h)
            ...
            for (e = b.anCells, h = 0, v = e.length; h < v; h++)
                t(e[h]);
    ...
    function ja(a, b) {
        ...
        if (-1 !== l.inArray(!1, c))
            ...
            if (a.bDeferLoading)
                a.bDeferLoading = !1, a.iDraw++, V(a, !1);
            else if (!k)
                a.iDraw++;
            ...
            if (0 !== m.length)
                ...
                d = f.sZeroRecords, 1 == a.iDraw && "ajax" == Q(a) ? d = f.sLoadingRecords : f.sEmptyTable && 0 === a.fnRecordsTotal() && (d = f.sEmptyTable), c[0] = l("<tr/>", {
                    "class": h ? e[0] : ""
                }).append(l("<td />", {
                            valign: "top",
                            colSpan: oa(a),
    ...
    function Kb(a) {
        ...
        var m = l("input", b).val(e.sSearch).attr("placeholder", "palabra clave").on("keyup.DT search.DT input.DT paste.DT cut.DT", h ? gb(k, h) : k).on("mouseup", function (n) {
            setTimeout(function () {
                k.call(m[0], n)
            }, 10)
    ...
    function Rb(a, b, c, d, e, h) {
        ...
        if (0 >= b.length)
            ...
            if (k ||
                c || d || f.length > b.length || 0 !== b.indexOf(f) || a.bSorted)
                a.aiDisplay = g.slice();
            b = a.aiDisplay;
    ...
    function Ra(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            ...
            e = 0;
            for (h = d.length; e < h; e++)
                f = d[e].src, l(U(a.aoData, "anCells", f)).addClass(c +
                    (2 > e ? e + 1 : 3))
        }
        a.aLastSort = d
    }
    ...
    function pb(a, b, c) {
        ...
        if (b &&
            ...
            if (-1 !== l.inArray(!1, f))
                a._bLoadingState = !1;
            else if (f = a.iStateDuration, 0 < f && b.time < +new Date - 1E3 * f)
                a._bLoadingState = !1;
    ...
    function da(a, b, c, d) {
        ...
        else if (b = u.ext, b = b.sErrMode || b.errMode, a && F(a, null, "error", [a, d, c]), "alert" == b)
            alert(c);
        else {
            if ("throw" == b)
                throw Error(c);
            ...
            for (h = g.length; n < h; n++) {
                ...
                if ("table" === b) {
                    ...
                    for (f = v.length; x < f; x++)
                        t = v[x], t = "cell" === b ? c.call(p, g[n], t.row,
    ...
    B.extend = function (a,
        ...
        if (c.length && b && (b instanceof B || b.__dt_wrapper)) {
            ...
            for (d = c.length; h < d; h++) {
                var f = c[h];
                b[f.name] = "function" === f.type ? e(a, f.val, f) : "object" === f.type ? {}
                 : f.val;
    ...
    Va = function (a, b) {
        ...
        b = b.page;
        if ("ssp" == Q(a))
            return "removed" === h ? [] : ra(0, e.length);
        if ("current" == b)
    ...
    y("row().data()", function (a) {
        var b = this.context;
        if (a === q)
            return b.length && this.length ? b[0].aoData[this[0]]._aData :
            q;
    ...
    var yc = function (a, b, c, d) {
        ...
        h = function (f, g) {
            if (Array.isArray(f) || f instanceof l)
                ...
                f.nodeName && "tr" === f.nodeName.toLowerCase() ? e.push(f) : (k = l("<tr><td></td></tr>").addClass(g), l("td", k).addClass(g).html(f)[0].colSpan =
                        oa(a), e.push(k[0]))
        };
        h(c, d);
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Muestra _START_ al _END_ de _TOTAL_ filas",
            sInfoEmpty: "Muestra 0 al 0 of 0 filas",
            sInfoFiltered: "(filtered from _MAX_ total filas)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    l.extend(u.ext.type.detect, [function (a, b) {
                ...
                if (a && !(a instanceof Date) && !uc.test(a))
                    return null;
                b = Date.parse(a);
