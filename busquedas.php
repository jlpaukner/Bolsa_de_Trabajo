...
<form action=fbusqueda.php method="POST"> 
  <div class="row">
    ...
    <div class="col-sm-2">
      ...
      <button type="submit" name="boton" class="form-control btn btn-dark  border border-primary" value="Añadir busqueda">Añadir busqueda</button>
    </div>
    <div class="col-sm-5"></div>
  </div>
 </form>